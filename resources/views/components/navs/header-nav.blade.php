<div x-data="{menu: false}" style="display: none">
    ...
    <div class="flex items-center justify-between bg-secondary border-b-2 border-accent px-4 py-1.5">
        <div>
            <img class="h-8 w-auto" src="https://tailwindui.com/img/logos/workflow-mark-indigo-600.svg" alt="Workflow">
        </div>
        <div>
            <button @click="menu = !menu" type="button"
                class="-mr-3 h-12 w-12 inline-flex items-center justify-center rounded-md text-accent hover:text-gray-900">
